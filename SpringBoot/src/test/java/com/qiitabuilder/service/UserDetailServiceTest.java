...
class UserDetailServiceTest {
    ...
    @Test
    void fetchUserDetails_ログインユーザーからのアクセス(){
        ...
        User user=userDetailService.fetchUserDetails(1);
        assertTrue(user.getIsLoginUser());
    }
    @Test
    void fetchUserDetails_非ログインユーザーからのアクセス(){
        jdbcTemplate.execute("INSERT INTO users(user_id, uid, password) VALUES (1, 'test_uid_1', 'test_password_1'), (2, 'test_uid_2', 'test_password_2')");
